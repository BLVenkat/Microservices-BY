package com.noteservice.noteService.config;
...
public class SwaggerConfig {
	...
	public Docket apiDocket() {
		...
		return new Docket(DocumentationType.SWAGGER_2).apiInfo(getApiInfo()).select()
				.apis(RequestHandlerSelectors.basePackage("com.noteservice.noteService")).paths(PathSelectors.any()).build().pathMapping("/");
	}
